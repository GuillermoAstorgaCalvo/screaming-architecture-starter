/**
 * SearchInputMessages Component Tests
 *
 * Tests for the SearchInputMessages component including:
 * - Rendering
...
describe('SearchInputMessages - Rendering', () => {
	it('renders nothing when no error and no helperText', () => {
		const { container } = renderWithProviders(<SearchInputMessages inputId="test-input" />);
	...
	it('renders error message when error is provided', () => {
		renderWithProviders(
			<SearchInputMessages inputId="test-input" error="This field is required" />
		);
	...
	it('renders helper text when helperText is provided', () => {
		renderWithProviders(
			<SearchInputMessages inputId="test-input" helperText="Enter keywords to search" />
		);
...
describe('SearchInputMessages - Error Message', () => {
	it('generates correct error ID', () => {
		renderWithProviders(<SearchInputMessages inputId="test-input" error="Error message" />);
	...
	it('handles different error messages', () => {
		const { rerender } = renderWithProviders(
			<SearchInputMessages inputId="test-input" error="First error" />
		);

		expect(screen.getByText('First error')).toBeInTheDocument();

		rerender(<SearchInputMessages inputId="test-input" error="Second error" />);
...
describe('SearchInputMessages - Helper Text', () => {
	it('generates correct helper ID', () => {
		renderWithProviders(<SearchInputMessages inputId="test-input" helperText="Helper text" />);
	...
	it('hides helper text when error is present', () => {
		renderWithProviders(
			<SearchInputMessages inputId="test-input" error="Error message" helperText="Helper text" />
		);
	...
	it('handles different helper text messages', () => {
		const { rerender } = renderWithProviders(
			<SearchInputMessages inputId="test-input" helperText="First helper" />
		);

		expect(screen.getByText('First helper')).toBeInTheDocument();

		rerender(<SearchInputMessages inputId="test-input" helperText="Second helper" />);
...
describe('SearchInputMessages - Accessibility', () => {
	...
	it('handles different input IDs', () => {
		renderWithProviders(<SearchInputMessages inputId="custom-input-id" error="Error message" />);
...
describe('SearchInputMessages - Edge Cases', () => {
	it('handles empty string error', () => {
		const { container } = renderWithProviders(
			<SearchInputMessages inputId="test-input" error="" />
		);
	...
	it('handles empty string helperText', () => {
		const { container } = renderWithProviders(
			<SearchInputMessages inputId="test-input" helperText="" />
		);
	...
	it('handles both empty strings', () => {
		const { container } = renderWithProviders(
			<SearchInputMessages inputId="test-input" error="" helperText="" />
		);
	...
	it('handles long error messages', () => {
		...
		renderWithProviders(<SearchInputMessages inputId="test-input" error={longError} />);
	...
	it('handles long helper text', () => {
		...
		renderWithProviders(<SearchInputMessages inputId="test-input" helperText={longHelper} />);
