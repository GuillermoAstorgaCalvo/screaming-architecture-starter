/**
 * NumberInputMessages Component Tests
 *
 * Tests for the NumberInputMessages component including:
 * - Rendering
...
describe('NumberInputMessages - Rendering', () => {
	it('renders nothing when no error and no helperText', () => {
		const { container } = renderWithProviders(<NumberInputMessages inputId="test-input" />);
	...
	it('renders error message when error is provided', () => {
		renderWithProviders(
			<NumberInputMessages inputId="test-input" error="This field is required" />
		);
	...
	it('renders helper text when helperText is provided', () => {
		renderWithProviders(<NumberInputMessages inputId="test-input" helperText="Enter a number" />);
...
describe('NumberInputMessages - Error Message', () => {
	it('generates correct error ID', () => {
		renderWithProviders(<NumberInputMessages inputId="test-input" error="Error message" />);
	...
	it('handles different error messages', () => {
		const { rerender } = renderWithProviders(
			<NumberInputMessages inputId="test-input" error="First error" />
		);

		expect(screen.getByText('First error')).toBeInTheDocument();

		rerender(<NumberInputMessages inputId="test-input" error="Second error" />);
...
describe('NumberInputMessages - Helper Text', () => {
	it('generates correct helper ID', () => {
		renderWithProviders(<NumberInputMessages inputId="test-input" helperText="Helper text" />);
	...
	it('hides helper text when error is present', () => {
		renderWithProviders(
			<NumberInputMessages inputId="test-input" error="Error message" helperText="Helper text" />
		);
	...
	it('handles different helper text messages', () => {
		const { rerender } = renderWithProviders(
			<NumberInputMessages inputId="test-input" helperText="First helper" />
		);

		expect(screen.getByText('First helper')).toBeInTheDocument();

		rerender(<NumberInputMessages inputId="test-input" helperText="Second helper" />);
...
describe('NumberInputMessages - Accessibility', () => {
	...
	it('handles different input IDs', () => {
		renderWithProviders(<NumberInputMessages inputId="custom-input-id" error="Error message" />);
...
describe('NumberInputMessages - Edge Cases', () => {
	it('handles empty string error', () => {
		const { container } = renderWithProviders(
			<NumberInputMessages inputId="test-input" error="" />
		);
	...
	it('handles empty string helperText', () => {
		const { container } = renderWithProviders(
			<NumberInputMessages inputId="test-input" helperText="" />
		);
	...
	it('handles both empty strings', () => {
		const { container } = renderWithProviders(
			<NumberInputMessages inputId="test-input" error="" helperText="" />
		);
	...
	it('handles long error messages', () => {
		...
		renderWithProviders(<NumberInputMessages inputId="test-input" error={longError} />);
	...
	it('handles long helper text', () => {
		...
		renderWithProviders(<NumberInputMessages inputId="test-input" helperText={longHelper} />);
