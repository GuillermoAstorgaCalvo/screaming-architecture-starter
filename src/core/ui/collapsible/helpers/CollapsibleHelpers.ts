...
export const CONTENT_BASE_CLASSES = 'overflow-hidden transition-all duration-normal ease-in-out';
export const CONTENT_EXPANDED_CLASSES = 'opacity-100';
export const CONTENT_EXPANDED_STYLE = {
	maxHeight: 'var(--animation-max-height-collapsible, 1000px)',
};
