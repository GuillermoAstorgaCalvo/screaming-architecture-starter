import { getInitialState } from '@core/ui/motion/motionStateHelpers';
import type { MotionBoxProps, MotionRepeat } from '@core/ui/motion/motionTypes';
import { getVariant } from '@core/ui/motion/motionVariantHelpers';
import {
	REDUCED_FADE_VARIANTS,
	STATIC_VARIANTS,
	withInstantTransitions,
} from '@core/ui/motion/reducedMotionVariants';
import type { useMotionConfig } from '@core/ui/motion/useMotionConfig';
